...
# 슬라이싱
print(address[9:]) #9번 인덱스 부터 끝까지 나옴
print(address[5:8])
print(address[1:12:4]) #1~12번까지 4개씩 건너뛰며 추출
print(address[::-1]) #문자열 뒤집기
print(address[-3:]) # 3 뒤에서 부터 끝까지
...
# 변수 포맷을 이용하여 문자열에 변수 값을 삽입 할 수 있따.
# 변수 포맷 종류 #
    # %s : 문자열
    # %c : 문자
    # %d : 정수
...
# 암시적 형 변환 : True는 1 / False는 0
print(True + 3)
print(3 + 5.0)
# print(3+'5') # 문자열과의 연산은 불가능
